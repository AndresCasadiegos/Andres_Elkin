                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="firstname" id="example-text-input" placeholder="Primer nombre"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Ultimo nombre</label>
                                       <input class="form-control" type="text" name="lastname" id="example-text-input-2" placeholder="Ultimo nombre"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Correo</label>
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Correo"> <small id="emailHelp" class="form-text text-muted">No vamos a compartir tu correo con alguien mas.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Numero de telefono</label>
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Telefono"> <small class="form-text text-muted">No vamos a compartir tu numero con alguien mas.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" class="form-control" name="cpassword" id="exampleInputPassword2" placeholder="Contraseña"> 
                                    </div>
									 <div class="form-group col-sm-12">
