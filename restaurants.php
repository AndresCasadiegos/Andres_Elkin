            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="restaurants.php">Elegir restaurante</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Elegir restaurante</a></li>
