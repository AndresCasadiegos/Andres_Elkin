                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>No tienes ordenes todavia. </center></td>';
														}
													else
														{			      
														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="Price">$ <?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info" style="font-weight:bold;">En reparto</button>
																		   <?php 
																			  }
																			...
																			if($status=="closed")
																				{
																			?>
																			 <button type="button" class="btn btn-success" ><span  class="fa fa-check-circle" aria-hidden="true"> Entregado</button> 
																			<?php 
																			} 
																			?>
																			<?php
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('¿Estas seguro de cancelar tu pedido?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
															</td>
