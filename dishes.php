            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Elegir restaurante</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Elige tu comida favorita</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pide y paga</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>Envio gratis</p>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check"  class="btn theme-btn btn-lg">Verificar</a>
                                    </div>
                                </div>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >$<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Añadir" />
										</div>
										</form>
                                    </div>
                                    <!-- end:row -->
